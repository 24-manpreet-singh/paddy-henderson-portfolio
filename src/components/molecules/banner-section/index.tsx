...
const BannerSection = () => {
    return (
        <React.Fragment>
            <section className="relative overflow-hidden md:flex md:h-screen pt-28 pb-14 items-center bg-gray-50 ">
                <div className="container relative">
                    <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-6">
                        <div>
                            ...
                            <p className="text-slate-400  text-[17px] max-w-xl mt-4"> {`Empowering growth through insightful content and compelling storytelling, Writer blends the power of lifelong learning with journalistic integrity to inform, inspire, and engage`}</p>
                        ...
                        <div className="relative lg:ms-6 before:content-[''] before:absolute before:start-1/2 before:-translate-x-1/2 rtl:before:translate-x-1/2 before:bottom-1/2 before:translate-y-1/2 before:w-[48rem] before:h-[20rem] before:rounded-[18rem] ltr:before:rotate-[135deg] rtl:before:rotate-[45deg] before:bg-orange-500">
                            <div className="relative z-1">
                                ...
                                <ImageWrapper
                                    ...
                                    className=''
                                />
                                <div className="absolute lg:bottom-20 -bottom-5 md:-start-10 -start-2 p-4 rounded-lg shadow-md  bg-white  m-3 w-44 text-center">
                                ...
                                <div className="absolute md:top-20 top-32 md:-end-10 -end-2 p-4 rounded-lg shadow-md  bg-white  m-3 w-44 text-center">

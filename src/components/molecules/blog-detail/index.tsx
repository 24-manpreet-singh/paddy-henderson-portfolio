                ...
                <div className="container relative">
                    <div className="md:flex ">
                        <div className="lg:w-3/5">
                            ...
                            <p className="text-slate-400  mt-4">{`Language is a window to who we are as people. Through the words we use and how we use them, people access a part of us, who we are.`}</p>
                            ...
                            <div className="flex items-center mt-5">
                                ...
                                <div className="ms-2">
                                    ...
                                    <span className="text-slate-400  text-sm block">Author</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="lg:w-[500px]">
                            <div className="relative">
                                ...
                                <div className="absolute bottom-2/4 translate-y-2/4 start-0 end-0 text-center">
                                    <a href="#!" data-type="youtube" className="lightbox h-20 w-20 rounded-full shadow-lg  inline-flex items-center justify-center bg-white  text-orange-500">

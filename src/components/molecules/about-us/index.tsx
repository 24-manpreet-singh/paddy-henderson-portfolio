                        ...
                        <div className="relative">
                            <div className="relative flex justify-end">
                                <ImageWrapper
                                    src={ABOUT_IMAGE}
                                    alt={"about us"}
                                    className='lg:w-[400px] w-[280px] rounded-xl shadow '
                                />
                                <div className="absolute top-0 translate-y-2/4 start-0 text-center">
                                    <a href="#!" data-type="youtube" className="lightbox h-20 w-20 rounded-full shadow-lg shadow-slate-100  inline-flex items-center justify-center bg-white  text-orange-600">
                            ...
                            <div className="absolute md:-start-5 start-0 -bottom-16">
                                <ImageWrapper
                                    src={ABOUT_IMAGE_2}
                                    alt={"about"}
                                    className='lg:w-[280px] w-[200px] border-8 border-white rounded-xl'
                                />
                            </div>
                        </div>
                    </div>

          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 md:grid-cols-2 gap-10 items-center">
            <div className="lg:col-span-5">
              <div className="relative">
                ...
                <div className="absolute bottom-2/4 translate-y-2/4 end-0 start-0 text-center">
                  <div data-type="youtube" className="lightbox h-20 w-20 rounded-full shadow-lg shadow-slate-100  inline-flex items-center justify-center bg-white  text-orange-500" onClick={() => setInformationDailog(true)}>
            ...
            <div className="lg:col-span-7">
              <div className="lg:ms-7">
                ...
                <p className="text-slate-400  max-w-2xl mx-auto">{`Start working with Paddy Henderson that can provide everything you need to generate awareness, drive traffic, connect. Dummy text is text that is used in the publishing industry or by web designers to occupy the space which will later be filled with 'real' content. This is required when, for example, the final text is not yet available. Dummy texts have been in use by typesetters since the 16th century.`}</p>
